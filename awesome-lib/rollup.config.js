...
function rollup({
  ...
  function outputFile(format) {
    return `${outputPrefix}-${name}.${format}.js`;
  }
...
export default rollup({
  ...
  .concat(
    rollup({
      ...
      outputPrefix: './dist/bundles/core/awesome-lib'
    })
  )
  .concat(
    rollup({
      name: 'feature1',
      input: './src/feature1/index.ts',
      outputPrefix: './dist/bundles/feature1/awesome-lib'
    })
  );
